...
int main() {
    long num1, num2;
    printf("Enter number 1 as base number: ");
    scanf("%ld", &num1);

    printf("Enter number 2 as power to number 1: ");
    scanf("%ld", &num2);
    ...
    struct LL_of_Pointers* head3 = Multiplication(head1, head1);
    struct Node* ans = AddPtr(head3);

    for(int i=1;i<num2-1;i++){
        head3 = Multiplication(ans, head1);
        ans = AddPtr(head3);
    }

    
    printf("Result after Expponent of Pointers:\n");
    printLL(ans);
    printf("\n");
    printf("\n");
